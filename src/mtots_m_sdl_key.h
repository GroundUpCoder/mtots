#ifndef mtots_m_sdl_key_h
#define mtots_m_sdl_key_h
...
static KeyConstant keyConstants[] = {
  ...
  {"PERIOD", SDLK_PERIOD},
  {"SLASH", SDLK_SLASH},
  {"K0", SDLK_0}, /* Modified to avoid starting with a digit */
  {"K1", SDLK_1}, /* Modified to avoid starting with a digit */
  {"K2", SDLK_2}, /* Modified to avoid starting with a digit */
  {"K3", SDLK_3}, /* Modified to avoid starting with a digit */
  {"K4", SDLK_4}, /* Modified to avoid starting with a digit */
  {"K5", SDLK_5}, /* Modified to avoid starting with a digit */
  {"K6", SDLK_6}, /* Modified to avoid starting with a digit */
  {"K7", SDLK_7}, /* Modified to avoid starting with a digit */
  {"K8", SDLK_8}, /* Modified to avoid starting with a digit */
  {"K9", SDLK_9}, /* Modified to avoid starting with a digit */
  {"COLON", SDLK_COLON},
...
/* Additional info on individual entries are available in the SDL source
 * https://github.com/libsdl-org/SDL/blob/main/include/SDL_scancode.h */
static KeyConstant scanConstants[] = {
  ...
  { "Y", SDL_SCANCODE_Y},
  { "Z", SDL_SCANCODE_Z},
  { "K1", SDL_SCANCODE_1}, /* Modified to avoid starting with a digit */
  { "K2", SDL_SCANCODE_2}, /* Modified to avoid starting with a digit */
  { "K3", SDL_SCANCODE_3}, /* Modified to avoid starting with a digit */
  { "K4", SDL_SCANCODE_4}, /* Modified to avoid starting with a digit */
  { "K5", SDL_SCANCODE_5}, /* Modified to avoid starting with a digit */
  { "K6", SDL_SCANCODE_6}, /* Modified to avoid starting with a digit */
  { "K7", SDL_SCANCODE_7}, /* Modified to avoid starting with a digit */
  { "K8", SDL_SCANCODE_8}, /* Modified to avoid starting with a digit */
  { "K9", SDL_SCANCODE_9}, /* Modified to avoid starting with a digit */
  { "K0", SDL_SCANCODE_0}, /* Modified to avoid starting with a digit */
